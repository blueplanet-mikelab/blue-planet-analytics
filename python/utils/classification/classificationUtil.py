...
def findThemeByKeyWord(content,tags):
    themeKeywords = [
        ['Mountain', 'เขา', 'เดินป่า',"camping","แคมป์","น้ำตก", "ทะเลสาบ","ป่าไม้",'เล่นน้ำตก','ล่องแก่ง'],
        ['Sea', 'ทะเล', 'ดำน้ำ', 'ชายหาด', 'ปะการัง','โต้คลื่น','หาดทราย','บิกินี','มหาสมุทร','ริมหาด','หาด'],
        ['Religion', 'ศาสนา', 'วัด',"สิ่งศักดิ์สิทธิ์","พระ","เณร","โบสถ์","มัสยิด","กราบ","บูชา","ทำบุญ","ทำทาน"], # หน้าวัด ห้าม ห
        ['Historical', 'โบราณสถาน', 'ประวัติศาสตร์','โบราณ','อดีต','เก่าแก่'],
        ['Entertainment', 'สวนสนุก', 'สวนสัตว์','สวนน้ำ','สวนสยาม','คาสิโน','อควาเรียม'],
        ['Festival', 'งานวัด', 'งานกาชาด','เทศกาล','จัดแสดง','อีเว้น','ลีค','งานแข่ง'],
        ['Eating', 'อาหาร', 'ร้านอาหาร', 'ขนม', 'ของหวาน',"ร้านกาแฟ", "อร่อย", 'ชา', 'เครื่องดื่ม','ของกิน','รสชาติ','คาเฟ่','ตลาดนัด'], # อาหาร แค่คำว่า match
        ...
        ['Sightseeing',"ชมเมือง","เดินเล่น","สถาปัตยกรรม","เที่ยวรอบเมือง","สองข้างทาง","ตัวเมือง","วิถีชีวิต"]
    ]
